...
def rsolve_hypergeometric(f, x, P, Q, k, m): # -> tuple[NaN | Any | Piecewise, Any, Zero | Expr | Any | NaN | NegativeInfinity | Number | ComplexInfinity | Rational | Infinity | Float] | None:
    """
...
def solve_de(f, x, DE, order, g, k): # -> tuple[NaN | Any | Piecewise, Any, Zero | Expr | Any | NaN | NegativeInfinity | Number | ComplexInfinity | Rational | Infinity | Float] | tuple[Any | Expr | ComplexInfinity | NaN | Rational | Zero | Infinity | NegativeInfinity | Float | _NotImplementedType, Zero, Zero] | None:
    """
    Solves the DE.
...
def hyper_algorithm(f, x, k, order=...): # -> tuple[NaN | Any | Piecewise, Any, Zero | Expr | Any | NaN | NegativeInfinity | Number | ComplexInfinity | Rational | Infinity | Float] | tuple[Any | Expr | ComplexInfinity | NaN | Rational | Zero | Infinity | NegativeInfinity | Float | _NotImplementedType, Zero, Zero] | tuple[Any | Expr | Zero, Zero, Zero] | None:
    """
...
def compute_fps(f, x, x0=..., dir=..., hyper=..., order=..., rational=..., full=...): # -> tuple[Any, Any, Any] | tuple[Any | SeqPer | SeqFormula, Any | SeqPer | SeqFormula, Any] | tuple[Any | SeqPer | SeqFormula, Any | None, Zero | Any | One | NegativeOne | Integer | NaN | ComplexInfinity | Rational | Infinity | NegativeInfinity | Float | Number | Expr] | None:
    """
