...
def conserve_mpmath_dps(func): # -> _Wrapped[..., Any, ..., Any]:
...
def deprecated(message, *, deprecated_since_version, active_deprecations_target, stacklevel=...): # -> Callable[..., type[wrapper] | _Wrapped[..., Any, ..., Any]]:
    '''
