...
class Mul(Expr, AssocOp):
    ...
    def as_content_primitive(self, radical=..., clear=...): # -> tuple[One | NegativeOne | Zero | Integer | NaN | ComplexInfinity | Rational | Infinity | NegativeInfinity | Float | _NotImplementedType | Expr | Any, Self]:
