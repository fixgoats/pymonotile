...
@DEBUG_WRAP
def expand_dirac_delta(expr): # -> tuple[Zero, dict[Any, One]] | tuple[Expr, dict[Any, Expr]] | tuple[Any | Mul, dict[Any, Any]] | tuple[Any | Expr, dict[Any, Any]] | tuple[Any, dict[Any, Any]]:
    """
