...
def prde_no_cancel_b_small(b, Q, n, DE): # -> tuple[list[Poly], MutablePolyDenseMatrix | Any]:
    """
...
def param_poly_rischDE(a, b, q, n, DE): # -> tuple[list[Any], PolyMatrix] | tuple[list[Any], MutablePolyDenseMatrix | list[Poly] | Poly | Any] | tuple[list[Poly], MutablePolyDenseMatrix | Any] | tuple[list[Any], Any | PolyMatrix] | tuple[list[list[Poly] | Poly | MutablePolyDenseMatrix | Any], MutablePolyDenseMatrix]:
