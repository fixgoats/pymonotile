...
@timeit
def meijerint_definite(f, x, a, b): # -> tuple[Zero, Literal[True]] | tuple[One | NegativeOne | Zero | Integer | NaN | ComplexInfinity | Rational | Infinity | NegativeInfinity | Float | Number | Expr | Any | int, Any | Basic] | tuple[Any, Any | Basic | Boolean | Literal[True]] | tuple[bool | Any | Basic, Any | Basic | Literal[True]] | tuple[Zero | Any, Any | Basic | Literal[True]] | tuple[Zero | One | NegativeOne | Integer | NaN | ComplexInfinity | Rational | Infinity | NegativeInfinity | Float | Number | Expr | Any, Boolean] | None:
    """
