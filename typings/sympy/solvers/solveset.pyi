...
def solve_decomposition(f, symbol, domain): # -> Set | FiniteSet | Intersection | Union | Complement | Any | ConditionSet:
    """
...
def substitution(system, symbols, result=..., known_symbols=..., exclude=..., all_symbols=...): # -> Set | FiniteSet | Intersection | Union | Complement | Any | ConditionSet:
    r"""
...
def nonlinsolve(system, *symbols): # -> FiniteSet | Set | Intersection | Union | Complement | Any | ConditionSet:
    r"""
