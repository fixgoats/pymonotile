...
def iter_numbered_constants(eq, start=..., prefix=...): # -> Generator[Symbol, Any, Never]:
    """
...
def dsolve(eq, func=..., hint=..., simplify=..., ics=..., xi=..., eta=..., x0=..., n=..., **kwargs): # -> list[Any] | Any | dict[Any, Any] | list[list[Any] | Any] | Equality | list[list[Any] | list[list[Any] | Any] | Any] | list[Equality | Any]:
    r"""
...
@vectorize(0)
def odesimp(ode, eq, func, hint): # -> list[Equality | Any] | list[list[Any] | list[list[Any] | Any] | Any] | Equality | list[list[Equality | Any] | list[list[Any] | list[list[Any] | Any] | Any] | Any]:
    r"""
...
@vectorize(0)
def constantsimp(expr, constants): # -> list[list[Any] | list[list[Any] | Any] | Any] | Equality | Add | Basic | Any:
    r"""
...
def sysode_nonlinear_3eq_order1(match_): # -> list[Any | Basic] | list[Any | list[Any] | dict[Any, Any] | list[list[Any] | Any] | Equality | list[list[Any] | list[list[Any] | Any] | Any] | list[Equality | Any]]:
    ...
