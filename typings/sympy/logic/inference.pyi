...
def satisfiable(expr, algorithm=..., all_models=..., minimal=..., use_lra_theory=...): # -> dict[Any, Any] | Generator[bool, None, None] | Generator[dict[Any, Any] | Literal[False], Any, None] | Generator[dict[Any, Any] | Literal[False], Any, Never] | dict[Any, bool] | Literal[False] | None:
    """
