...
class DMP(CantSympify):
    ...
    def resultant(f, g, includePRS=...): # -> tuple[Any | DMP_Python | list[list[list[Any]]] | list[Any | list[Any]] | list[Any] | list[list[Any]], list[DMP_Python]] | DMP_Python | tuple[Any, list[Any]] | tuple[list[list[list[Any]]], list[Any]] | tuple[list[list[list[Any]]] | Any | list[Any | list[Any]] | list[Any], list[Any]] | list[list[list[Any]]] | list[Any] | list[Any | list[Any]]:
...
class DMP_Python(DMP):
    ...
    def unify(f, g): # -> tuple[int, Domain, Callable[..., Self], Any, Any] | tuple[int, Any, Callable[..., Self], Any | list[Any] | list[list[list[Any]]], Any | list[Any] | list[list[list[Any]]]]:
    ...
    def discriminant(f): # -> DMP_Python | list[list[list[Any]]]:
        """Computes discriminant of ``f``. """
        ...
    ...
    def sqf_norm(f): # -> tuple[list[int] | Any, Self, Any | DMP_Python]:
        """Computes square-free norm of ``f``. """
        ...
    ...
    def factor_list_include(f): # -> list[tuple[Self, int | Any]]:
        """Returns a list of irreducible factors of ``f``. """
        ...
...
class DUP_Flint(DMP):
    ...
    def factor_list_include(f): # -> list[tuple[Any, int | Any]]:
        """Returns a list of irreducible factors of ``f``. """
        ...
...
class DMF(PicklableWithSlots, CantSympify):
    ...
    def poly_unify(f, g): # -> tuple[Any | int, Any, Callable[..., Any | Self], tuple[Any | list[Any] | list[list[Any]], Any | list[Any] | list[list[Any]]], Any] | tuple[Any | int, Any, Callable[..., Any | Self], tuple[Any | list[Any] | list[list[Any]] | list[list[list[Any]]], Any | list[Any] | list[list[Any]] | list[list[list[Any]]]], Any | list[Any] | list[list[list[Any]]]]:
        """Unify a multivariate fraction and a polynomial. """
        ...
    
    def frac_unify(f, g): # -> tuple[Any | int, Any, Callable[..., Any | Self], tuple[Any | list[Any] | list[list[Any]], Any | list[Any] | list[list[Any]]], tuple[Any | list[Any] | list[list[Any]], Any | list[Any] | list[list[Any]]]] | tuple[Any | int, Any, Callable[..., Any | Self], tuple[Any | list[Any] | list[list[Any]] | list[list[list[Any]]], Any | list[Any] | list[list[Any]] | list[list[list[Any]]]], tuple[Any | list[Any] | list[list[Any]] | list[list[list[Any]]], Any | list[Any] | list[list[Any]] | list[list[list[Any]]]]]:
