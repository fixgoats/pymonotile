...
def dup_sqf_norm(f, K): # -> tuple[int, Any | list[Any], tuple[Any, list[Any]] | Any | tuple[list[list[list[Any]]], list[Any]] | tuple[list[list[list[Any]]] | Any | list[Any | list[Any]] | list[Any], list[Any]] | list[list[list[Any]]] | list[Any] | list[Any | list[Any]]]:
    r"""
...
def dmp_sqf_norm(f, u, K): # -> tuple[list[int], Any | list[Any], tuple[Any, list[Any]] | Any | tuple[list[list[list[Any]]], list[Any]] | tuple[list[list[list[Any]]] | Any | list[Any | list[Any]] | list[Any], list[Any]] | list[list[list[Any]]] | list[Any] | list[Any | list[Any]]] | tuple[Any, Any | list[Any] | list[list[Any] | Any | list[list[Any] | Any | list[list[Any] | Any | list[list[list[Any]]]] | list[list[list[Any]]]] | list[list[list[Any]]]] | list[list[list[Any]]], tuple[Any, list[Any]] | Any | tuple[list[list[list[Any]]], list[Any]] | tuple[list[list[list[Any]]] | Any | list[Any | list[Any]] | list[Any], list[Any]] | list[list[list[Any]]] | list[Any] | list[Any | list[Any]]]:
    r"""
    Find a shift of ``f`` in ``K[X]`` that has square-free norm.
...
def dmp_norm(f, u, K): # -> tuple[Any, list[Any]] | tuple[list[list[list[Any]]], list[Any]] | tuple[list[list[list[Any]]] | Any | list[Any | list[Any]] | list[Any], list[Any]] | list[list[list[Any]]] | list[Any] | list[Any | list[Any]]:
    r"""
...
def dmp_sqf_part(f, u, K): # -> list[Any] | list[int] | list[list[list[Any]]] | list[Any | list[Any] | list[Any | list[Any]]]:
    """
    Returns square-free part of a polynomial in ``K[X]``.
