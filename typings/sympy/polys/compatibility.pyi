...
class IPolys:
    ...
    def to_dense(self, element): # -> list[Any] | list[list[list[Any]]]:
        ...
    ...
    def dup_max_norm(self, f): # -> Any:
        ...
    
    def dmp_max_norm(self, f):
        ...
    
    def dup_l1_norm(self, f): # -> Any | int:
        ...
    ...
    def dup_LC(self, f): # -> Any | list[list[Any]]:
        ...
    
    def dmp_LC(self, f): # -> Any:
        ...
    
    def dup_TC(self, f): # -> Any | list[list[Any]]:
        ...
    
    def dmp_TC(self, f): # -> Any:
        ...
    ...
    def dup_degree(self, f): # -> float | int:
        ...
    
    def dmp_degree(self, f): # -> float | int:
        ...
    
    def dmp_degree_in(self, f, j): # -> float | int:
        ...
    ...
    def dmp_inner_subresultants(self, f, g): # -> tuple[list[None], list[list[list[list[Any]]] | Any | list[Any | list[Any]]] | list[list[list[list[Any]]] | Any | list[Any | list[Any]] | list[Any]]]:
        ...
    ...
    def dmp_resultant(self, f, g): # -> tuple[Any, list[Any]] | tuple[list[list[list[Any]]], list[Any]] | tuple[list[list[list[Any]]] | Any | list[Any | list[Any]] | list[Any], list[Any]]:
        ...
    
    def dup_discriminant(self, f): # -> Any:
        ...
    ...
    def dmp_ground_content(self, f): # -> Any:
        ...
    
    def dmp_ground_primitive(self, f): # -> tuple[Any, None]:
        ...
    
    def dup_cancel(self, f, g, include=...): # -> tuple[Any | list[Any] | list[list[Any]], Any | list[Any] | list[list[Any]], None, None] | tuple[None, None]:
        ...
    
    def dmp_cancel(self, f, g, include=...): # -> tuple[Any | list[Any] | list[list[Any]], Any | list[Any] | list[list[Any]], None, None] | tuple[None, None]:
        ...
    ...
    def dup_zz_factor(self, f): # -> tuple[Any, list[tuple[None, Any | int]]]:
        ...
    
    def dmp_zz_factor(self, f): # -> tuple[Any, list[tuple[None, Any | int]]]:
        ...
    ...
    def dup_ext_factor(self, f): # -> tuple[Any, list[tuple[None, int | float]]]:
        ...
    
    def dmp_ext_factor(self, f): # -> tuple[Any, list[tuple[None, int | float]]]:
        ...
    ...
    def dup_factor_list_include(self, f): # -> list[tuple[None, int | Any]]:
        ...
    
    def dmp_factor_list(self, f): # -> tuple[Any, list[tuple[None, Any]]]:
        ...
    
    def dmp_factor_list_include(self, f): # -> list[tuple[None, int | Any]]:
        ...
    ...
    def dmp_sqf_norm(self, f): # -> tuple[list[int] | Any, None, Any]:
        ...
    ...
    def dup_sqf_list_include(self, f, all=...): # -> list[tuple[None, int]]:
        ...
    
    def dmp_sqf_list(self, f, all=...): # -> tuple[Any, list[tuple[None, Any]]]:
        ...
    
    def dmp_sqf_list_include(self, f, all=...): # -> list[tuple[None, int | Any]]:
        ...
    
    def dup_gff_list(self, f): # -> list[tuple[None, Any | int]]:
        ...
    ...
    def dup_step_refine_real_root(self, f, M, fast=...): # -> tuple[Any, tuple[Any, Any, Any, Any]] | tuple[list[Any], tuple[Any, Any, Any, Any]]:
        ...
    
    def dup_inner_refine_real_root(self, f, M, eps=..., steps=..., disjoint=..., fast=..., mobius=...): # -> tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]:
        ...
    
    def dup_outer_refine_real_root(self, f, s, t, eps=..., steps=..., disjoint=..., fast=...): # -> tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]:
        ...
    
    def dup_refine_real_root(self, f, s, t, eps=..., steps=..., disjoint=..., fast=...): # -> tuple[Any, Any] | tuple[Any | list[Any], Any | tuple[Any, Any, Any, Any]]:
        ...
    
    def dup_inner_isolate_real_roots(self, f, eps=..., fast=...): # -> list[Any] | list[tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]]:
        ...
    
    def dup_inner_isolate_positive_roots(self, f, eps=..., inf=..., sup=..., fast=..., mobius=...): # -> list[Any] | list[tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]]:
        ...
    
    def dup_inner_isolate_negative_roots(self, f, inf=..., sup=..., eps=..., fast=..., mobius=...): # -> list[Any] | list[tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]]:
        ...
    
    def dup_isolate_real_roots_sqf(self, f, eps=..., inf=..., sup=..., fast=..., blackbox=...): # -> list[Any] | list[tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]] | list[RealInterval]:
        ...
    
    def dup_isolate_real_roots(self, f, eps=..., inf=..., sup=..., basis=..., fast=...): # -> list[Any] | list[tuple[tuple[Any, Any], Any, Any] | tuple[Any, Any]]:
        ...
    
    def dup_isolate_real_roots_list(self, polys, eps=..., inf=..., sup=..., strict=..., basis=..., fast=...): # -> list[tuple[tuple[Any, Any], Any, Any] | tuple[tuple[Any, Any], dict[Any, Any]]]:
        ...
    ...
    def dup_isolate_complex_roots_sqf(self, f, eps=..., inf=..., sup=..., blackbox=...): # -> list[Any]:
        ...
    
    def dup_isolate_all_roots_sqf(self, f, eps=..., inf=..., sup=..., fast=..., blackbox=...): # -> tuple[list[Any] | list[tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]] | list[RealInterval], list[Any]]:
        ...
    
    def dup_isolate_all_roots(self, f, eps=..., inf=..., sup=..., fast=...): # -> tuple[list[tuple[tuple[Any | list[Any], Any | tuple[Any, Any, Any, Any]], Any]], list[tuple[tuple[Any, Any], Any]]]:
        ...
    ...
    def to_gf_dense(self, element): # -> list[Any]:
        ...
    ...
    def gf_sqf_list(self, f, all=...): # -> tuple[Any | int, list[tuple[None, Any]]]:
        ...
