...
def dmp_zz_diophantine(F, c, A, d, p, u, K): # -> list[list[Any]] | list[Any | list[Any | list[Any] | list[list[list[Any]]]] | list[list[list[Any]]]]:
...
def dup_factor_list_include(f, K): # -> list[tuple[Any, int]]:
    """Factor univariate polynomials into irreducibles in `K[x]`. """
    ...
...
def dmp_factor_list_include(f, u, K): # -> list[tuple[list[list[list[Any]]] | Any | list[Any | list[Any]], int]]:
    """Factor multivariate polynomials into irreducibles in `K[X]`. """
    ...
