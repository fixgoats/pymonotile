...
def tensorproduct(*args): # -> One | NDimArray | ImmutableDenseNDimArray | PermuteDims | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | ImmutableSparseNDimArray:
    """
...
def tensorcontraction(array, *contraction_axes): # -> Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Any | ImmutableDenseNDimArray:
    """
...
def tensordiagonal(array, *diagonal_axes): # -> ArrayDiagonal | Any | ImmutableDenseNDimArray:
    """
