...
def _(expr: ArrayTensorProduct): # -> Mul:
    ...

@_array2matrix.register(ArrayContraction)
def _(expr: ArrayContraction): # -> Expr | MatMul | Mul | PermuteDims | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Trace | None:
    ...
...
def _(expr: PermuteDims): # -> PermuteDims | Any | Transpose | Mul:
    ...
...
def _(expr: ArrayTensorProduct): # -> tuple[Any | Mul, list[int] | list[Any]]:
    ...
...
def _(expr: ArrayContraction): # -> tuple[Any, list[int]] | tuple[Basic | Any | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction, list[int]]:
    ...
