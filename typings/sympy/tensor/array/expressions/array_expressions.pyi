...
class ArrayTensorProduct(_CodegenArrayAbstract):
    ...
    """
    def __new__(cls, *args, **kwargs): # -> PermuteDims | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Self:
        ...
    
    def as_explicit(self): # -> One | NDimArray | ImmutableDenseNDimArray | PermuteDims | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | ImmutableSparseNDimArray:
        ...
...
class PermuteDims(_CodegenArrayAbstract):
    ...
    [1, 0, 3, 2]
    """
    def __new__(cls, expr, permutation=..., index_order_old=..., index_order_new=..., **kwargs): # -> Zero | ZeroArray | Basic | Self:
        ...
    ...
    def nest_permutation(self): # -> Self | PermuteDims | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction:
        r"""
        DEPRECATED.
        """
        ...
...
class ArrayDiagonal(_CodegenArrayAbstract):
    ...
    def as_explicit(self): # -> ArrayDiagonal | Any | ImmutableDenseNDimArray:
        ...
...
class ArrayContraction(_CodegenArrayAbstract):
    ...
    """
    def __new__(cls, expr, *contraction_indices, **kwargs): # -> Basic | Zero | ZeroArray | ArrayTensorProduct | Self:
        ...
    ...
    def flatten_contraction_of_diagonal(self): # -> Self | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction:
        ...
    ...
    def sort_args_by_name(self): # -> Self | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction:
        """
    ...
    def as_explicit(self): # -> Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Any | ImmutableDenseNDimArray:
        ...
...
def nest_permutation(expr): # -> PermuteDims | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction:
    ...
