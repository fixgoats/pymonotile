...
class _TensorDataLazyEvaluator(CantSympify):
    ...
    def __getitem__(self, key): # -> Any | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Tuple | Indexed | ImmutableDenseNDimArray | NDimArray | None:
        ...
    
    @staticmethod
    def data_contract_dum(ndarray_list, dum, ext_rank): # -> Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Any | ImmutableDenseNDimArray:
        ...
    
    def data_tensorhead_from_tensmul(self, data, tensmul, tensorhead): # -> Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Any | ImmutableDenseNDimArray | None:
        """
    ...
    def data_from_tensor(self, tensor): # -> Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Any | ImmutableDenseNDimArray | None:
        """
...
class TensorIndexType(Basic):
    ...
    __repr__ = ...
    @property
    def data(self): # -> Any | Basic | Zero | ZeroArray | ArrayTensorProduct | ArrayContraction | Tuple | Indexed | ImmutableDenseNDimArray | NDimArray | None:
        ...
