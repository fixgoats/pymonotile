...
from sympy.sets.fancysets import ComplexRegion, ImageSet, Integers, Naturals, Range, Rationals, Reals
...
def _(a, b): # -> Set | FiniteSet | Intersection | Union | Complement | Any | ConditionSet:
    ...
...
def _(self, other): # -> FiniteSet | Set | Intersection | Union | Complement | Any | None:
    ...
