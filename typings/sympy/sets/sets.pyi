...
class Set(Basic, EvalfMixin):
    ...
    if TYPE_CHECKING:
        ...
        @overload
        def subs(self, arg1: Mapping[Basic | complex, Set | complex], arg2: None = ...) -> Set:
            ...
        
        @overload
        def subs(self, arg1: Iterable[tuple[Basic | complex, Set | complex]], arg2: None = ..., **kwargs: Any) -> Set:
            ...
        ...
        def evalf(self, n: int = ..., subs: dict[Basic, Basic | float] | None = ..., maxn: int = ..., chop: bool = ..., strict: bool = ..., quad: str | None = ..., verbose: bool = ...) -> Set:
            ...
    ...
    def intersect(self, other): # -> FiniteSet | Intersection | Union | Complement | Any:
        """
    ...
    def intersection(self, other): # -> FiniteSet | Intersection | Union | Complement | Any:
        """
    ...
    @property
    def is_open(self): # -> FuzzyBool | Any:
        """
    ...
    @sympify_return([('other', 'Set')], NotImplemented)
    def __and__(self, other): # -> FiniteSet | Intersection | Union | Complement | Any:
        ...
...
class Intersection(Set, LatticeOp):
    ...
    def __new__(cls, *args, evaluate=...): # -> FiniteSet | Intersection | Union | Complement | Any | Self:
        ...
...
def simplify_intersection(args): # -> FiniteSet | Intersection | Union | Complement | Any:
    """
