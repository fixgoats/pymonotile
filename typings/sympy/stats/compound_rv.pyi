...
class CompoundPSpace(PSpace):
    ...
    def probability(self, condition, *, compound_evaluate=..., **kwargs): # -> Zero | One | Integral | Probability | NegativeOne | Integer | NaN | ComplexInfinity | Rational | Infinity | NegativeInfinity | Float | Number | Expr | Literal[0]:
        ...
    
    def conditional_space(self, condition, *, compound_evaluate=..., **kwargs): # -> ContinuousPSpace | FinitePSpace | DiscretePSpace:
        ...
