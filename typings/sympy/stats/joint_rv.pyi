...
class SampleJointScipy:
    ...
    def __new__(cls, dist, size, seed=...): # -> ndarray[_Shape, dtype[float64]] | NDArray[long] | NDArray[int64] | None:
        ...
...
class JointDistribution(Distribution, NamedArgsMixin):
    ...
    def sample(self, size=..., library=..., seed=...): # -> NDArray[float64] | NDArray[int64] | NDArray[long]:
