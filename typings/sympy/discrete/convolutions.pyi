...
"""
def convolution(a, b, cycle=..., dps=..., prime=..., dyadic=..., subset=...): # -> list[int] | list[Any | int] | Any | list[Any] | list[Zero] | list[Rational | NaN | ComplexInfinity] | list[Rational | NaN | ComplexInfinity | int]:
    """
...
def convolution_subset(a, b): # -> list[Any] | Any | list[Zero]:
    """
...
def convolution_int(a, b): # -> list[Any]:
