...
def bifid_square(key): # -> MutableDenseMatrix:
...
def bifid5_square(key=...): # -> MutableDenseMatrix:
    r"""
    5x5 Polybius square.
...
def bifid6_square(key=...): # -> MutableDenseMatrix:
    r"""
    6x6 Polybius square.
...
def rsa_public_key(*args, **kwargs): # -> tuple[Any, Any] | Literal[False]:
...
def rsa_private_key(*args, **kwargs): # -> tuple[Any, Any] | Literal[False]:
...
def encipher_rsa(i, key, factors=...): # -> int:
...
def decipher_rsa(i, key, factors=...): # -> int:
...
def lfsr_autocorrelation(L, P, k): # -> Rational | NaN | ComplexInfinity:
    """
...
def elgamal_private_key(digit=..., seed=...): # -> tuple[int | None, int | Any | None, int | Any]:
    r"""
...
def dh_private_key(digit=..., seed=...): # -> tuple[int | None, int | Any | None, int | Any]:
    r"""
