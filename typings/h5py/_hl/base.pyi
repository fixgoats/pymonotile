...
def array_for_new_object(data, specified_dtype=...): # -> ndarray[_Shape, dtype[generic[Any]]] | NDArray[Any]:
...
class _RegionProxy:
    ...
    def selection(self, ref): # -> tuple[()] | tuple[Literal[0], ...] | tuple[Any] | tuple[Any | int, ...] | None:
